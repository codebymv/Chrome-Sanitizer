...
async function extractWithOcr(doc) {
  if (typeof document === "undefined") {
    return { pageTexts: [], spans: [], extractedChars: 0, pagesScanned: 0 };
  }
  const pageTexts = [];
  const spans = [];
  let extractedChars = 0;
  ...
  return { pageTexts, spans, extractedChars, pagesScanned: pageCount };
}
